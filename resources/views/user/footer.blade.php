            ...
            <div class="row">
                <div class="col-md-5 col-sm-6 col-xs-12">
                    <div class="footer_top_right">
                        <ul id="payment">
                            <li><a href="">
                                    <img src="{{ asset('style/images/pay1.png') }}" alt="" />
                                </a></li>
                            <li><a href="">
                                    <img src="{{ asset('style/images/pay2.png') }}" alt="" />
                                </a></li>
                            <li><a href="">
                                    <img src="{{ asset('style/images/pay3.png') }}" alt="" />
                                </a></li>
                            <li><a href="">
                                    <img src="{{ asset('style/images/pay4.png') }}" alt="" />
                                </a></li>
                            <li><a href="">
                                    <img src="{{ asset('style/images/pay5.png') }}" alt="" />
                                </a></li>
                        </ul>
                    </div>
                </div>
