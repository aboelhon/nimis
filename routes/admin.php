...
################### LanuageMiddleware for all admin routes  ###################
Route::middleware(['LanuageMiddleware'])->group(function () {

    Route::get('/ar',[LanguageController::class,'ar'])->name('ar');
